...
export function myrobodetection_allEvents(a: number, b: number): void;
export function myrobodetection_events(a: number, b: number, c: number, d: number): void;
export function myrobodetection_num_events(a: number): number;
...
export function __wbg_set_robodetectionoutput_timestamp(a: number, b: number): void;
export function __wbg_get_robodetectionoutput_timestamp(a: number): number;
